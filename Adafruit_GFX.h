...
public:
  ...
  */
  ...
  virtual void drawRect(int16_t x, int16_t y, int16_t w, int16_t h,
                        uint16_t color);
    virtual void drawPentagram(int16_t x0, int16_t y0, int16_t r0, uint16_t color);
    virtual void drawEllipse(int16_t x1, int16_t y1, int16_t x2, int16_t y2, int16_t a, uint16_t color);
