...
/// Fixed point math for trigonometric functions
 ...
 */
/**************************************************************************/
static inline int16_t double_to_q15(const double d) { return lrint(d * 32768); }
 ...
 */
/**************************************************************************/
static inline int16_t i16_nabs(const int16_t x) { return x < 0 ? x : -x; }
